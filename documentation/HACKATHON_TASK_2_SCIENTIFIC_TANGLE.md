# Научный клубок — Задача 2

**Источник:** [nornickel-ai-hackathon.ru/task-2](https://nornickel-ai-hackathon.ru/task-2)  
**Хакатон:** NorNickel AI Hackathon  
...
**Архив данных:** [https://disk.yandex.ru/d/npigiuw4Rbe9Pg](https://disk.yandex.ru/d/npigiuw4Rbe9Pg)
...
2. **Ссылка на облачный диск** (Яндекс, Google), где загружены:
   ...
   - Видео-демо работы проекта (не длиннее 5 минут)
3. **Ссылка на презентацию** (.pptx/.pdf или развёрнутая презентация на YouNote, Figma и т.п.)
4. **Ссылка на развёрнутое решение** (при наличии) для тестирования жюри
...
- Telegram: [Чат хакатона](https://t.me/nornickel_hackathon)

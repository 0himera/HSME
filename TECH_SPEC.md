...
*   **Логирование аудита**: Метод `log_action()` в [database.py](file:///home/himera/projects/HSME/backend/database.py) сохраняет в файл БД все действия пользователей (IP, роль, действие, детали). Эндпоинт `/api/audit-logs` доступен только администратору.
